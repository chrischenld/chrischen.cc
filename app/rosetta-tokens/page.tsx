  ...
  return (
    <main className="flex flex-col px-2 pt-4 md:p-0 gap-4 min-h-screen items-center">
      ...
      <div className="flex flex-col gap-6 pt-4 md:pt-32 pb-16 md:max-w-lg lg:max-w-xl text-neutral-400 text-sm lowercase">
        ...
        <Image src={search01} alt="placeholder" priority={false}></Image>
        <p>
        ...
        <Image src={search02} alt="placeholder" priority={false}></Image>
        ...
        <Image src={search03} alt="placeholder" priority={false}></Image>
        <p>
        ...
        <Image src={search07} alt="placeholder" priority={false}></Image>
        <p>
